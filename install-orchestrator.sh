...
main ()
{
  ...
  gpg_key_url="https://packagecloud.io/github/orchestrator/gpgkey"
  apt_config_url="https://packagecloud.io/install/repositories/github/orchestrator/config_file.list?os=${os}&dist=${dist}&source=script"

  apt_source_path="/etc/apt/sources.list.d/github_orchestrator.list"
  apt_keyrings_dir="/etc/apt/keyrings"
  if [ ! -d "$apt_keyrings_dir" ]; then
    mkdir -p "$apt_keyrings_dir"
  fi
  gpg_keyring_path="$apt_keyrings_dir/github_orchestrator-archive-keyring.gpg"
  ...
  then
    ...
    mv ${gpg_keyring_path} /etc/apt/trusted.gpg.d/github_orchestrator.gpg
